 ...
 * - presence → to know who is online (multi-device safe)
 */
export default function friendRoutes(io, presence) {
  ...
  router.post("/request", auth, (req, res) =>
    sendRequest(req, res, io, presence)
  );
   ...
   */
  router.post("/dummy_incoming", auth, (req, res) =>
    createDummyIncomingRequest(req, res, io, presence)
  );
